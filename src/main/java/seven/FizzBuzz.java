...
public class FizzBuzz {
    public static void main(String[] args) {
        ...
        firstSolutionThreeTernaryOperators();

        secondSolutionTwoTernaryOperators();

        thirdSolutionWithoutIfsAndTernaryOperators();
    }

    private static void thirdSolutionWithoutIfsAndTernaryOperators() {
    ...
    private static void secondSolutionTwoTernaryOperators() {
    ...
    private static void firstSolutionThreeTernaryOperators() {
